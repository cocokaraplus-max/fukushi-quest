/* FUKUSHI QUEST PWA service worker
   ...
   ------------------------------------------------------------------ */
const CACHE = 'fq326-v18';  // fq-flyer2-v1: img/date.png の中身を差し替えたので版を上げる
// ★名前を変えずに絵の中身だけ差し替えたときは、必ずここを上げること。
//   上げないと、端末に残った古い絵（白い丸の「日」）が出続ける。
//   ★名前が新しい絵（time.png / time_note.png）は、上げなくても出る。
